...
public abstract class MainActivity extends LinphoneGenericActivity
        ...
        dialer.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        addFlagsToIntent(intent);
                        startActivity(intent);
                        ChangeStatusFragmentTitle("Dial Number");
                    }
                });
    ...
    public void ChangeStatusFragmentTitle(String title) {
        StatusBarFragment statusBarFragment =
                (StatusBarFragment) getFragmentManager().findFragmentById(R.id.status_fragment);
        TextView tv = statusBarFragment.getView().findViewById(R.id.status_title);
        tv.setText(title);
    }
